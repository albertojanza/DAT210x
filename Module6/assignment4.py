...
#Module 6 Assigment 4
#No starter code this time. Instead, take your completed Module6/assignment1.py and modify 
#it by adding in a Decision Tree Classifier, setting its max_depth to 9, and random_state=2, 
#but not altering any other setting
from sklearn import tree
tree = tree.DecisionTreeClassifier(max_depth=9, random_state=2) # criterion="entropy")
